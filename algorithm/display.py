...
def display_polinomials(training_data, unique_timestamps, training_feature_mean, training_interpolation_polynomial, day_data, day_interpolation_polynomial):
    """Display the given plinomials.
    ...
    plot.scatter(unique_timestamps, training_feature_mean, color='gray', label='avarage data points for November')
